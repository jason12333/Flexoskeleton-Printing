...
Hybrid robots composed of rigid and soft elements have previously required access to expensive multi-material 3D printers, multi-step casting and machining processes, or limited material choice when using consumer grade fabrication methods. Here we introduce a new design and fabrication process to rapidly construct flexible exoskeleton-inspired robots called **"flexoskeleton printing"**. The process is based on the modification of consumer grade fused deposition material (FDM) 3D printers to deposit filament directly onto a heated thermoplastic base layer which provides extremely strong bond strength between deposited material and the inextensible yet flexible base layer. This method significantly improves the fatigue resistance of printed components and enables a new class of insect-inspired robot morphologies, such as joint limits based on jamming or interlocking of rigid [mushrooms](https:cite)
